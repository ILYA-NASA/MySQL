...
0. [SQL](#Structured-Query-Language)
    1. [DDL](#DDL-–-Data-Definition-Language)
    2. [DML](#DML-–-Data-Manipulation-Language)
    3. [DCL](#DCL-–-Data-Control-Language)
    4. [TCL](#TCL-–-Transaction-Control-Language)
1. [SELECT](#Базовый-синтаксис-SQL-команды-SELECT)
2. [WHERE](#Условный-оператор-WHERE)
3. [IF](#Функция-IF-в-MySQL)
4. [IFNULL](#Функция-IFNULL-в-MySQL)
5. [COALESCE](#Функция-COALESCE-в-MySQL)
6. [COALESCE](#Функция-COALESCE-в-MySQL)
